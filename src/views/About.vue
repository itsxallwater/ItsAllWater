    ...
    <div class="py-12 bg-white leading-normal text-2xl">
      <p class="mb-6">
        ...
        <a
          ...
          >Zumasys</a
        >
        since late 2018. While I came on as a Senior Software Developer, by
        January of 2020 I became Director of Technology. My work with Zumasys
        primarily consists of directing the Product Support, Internal
        Development and Internal Helpdesk/IT groups. I also co-chair Product
        Development and am a general open source evangelist for the organization
        (I am super passionate about the
        <a
      ...
      <ol class="mb-6">
        ...
        <li>PickBASIC (jBASE, OpenQM, D3, UniVerse)</li>
        <li>ASP.NET Core</li>
        <li>C#</li>
        <li>Java</li>
      </ol>
      <p class="mb-6">
        ...
        (re: my whole career) at a timeshare servicing company based in
        Scottsdale. Though I no longer work there, I'm extremely appreciative of
        the opportunities that were provided to me. My experience there allowed
        me to grow as a developer across several technology stacks:
      </p>
      <ol class="mb-6">
      ...
      <p class="mb-6">
        ...
        take a strong sense of ownership and pride in my work. Not to mention, I
        established great friendships with many individuals that will never fade
        away. That time has led me to the present, where I'm excited to bring
        those skills to help out anyone in need!
      </p>
      <p>
        Outside of providing freelance software development, I'm a husband to an
        amazing woman and father to an equally amazing son. I'm also a huge
        sports fan, supporting all of the local professional teams plus Arizona
        State. When I'm not hanging with the family or watching games, you're
        likely to find me coding, running, cycling or enjoying the great
        culinary and brewery scenes of Phoenix! If you're reading this wanting
        more, you'll find my blog at
        <a
