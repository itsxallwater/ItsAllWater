<template>
  <div class="py-64">
    <h1 class="header">It's All Water, LLC - Privacy Policy</h1>
    <p class="lead">Effective date: November 02, 2018</p>
    <p class="lead">
    ...
    <p class="lead">
      ...
      have associated with that data. Our Privacy Policy for It's All Water, LLC
      is managed through
      <a
    ...
    <p class="lead">
      ...
      accessible from https://www.itsallwater.net
    </p>
    ...
    <ul>
      <li>
        <p class="lead"><strong>Google Analytics</strong></p>
        <p class="lead">
    ...
    <ul>
      <li>
        ...
        https://www.itsallwater.net/Privacy
      </li>
    </ul>
  </div>
</template>
